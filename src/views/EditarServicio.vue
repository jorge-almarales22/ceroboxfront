    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card shadow rounded">
                <div class="card-body">
                    <form @submit.prevent="updateServicio()" enctype="multipart/formdata">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <router-link class="btn btn-default btn-lg btn-block mt-2" to="/servicios">Back</router-link> 
                        </div>
                    </form>
                </div>
            </div>
...
export default {
    ...
    computed:{
      ...
      created(){
        this.servicio = this.servicios.find(item => item.id == this.$route.params.id);
    },
    methods:{
        inputFile(e){
        ...
        updateServicio(){
            ...
            axios.put(`http://127.0.0.1:8000/api/auth/servicios/${this.$route.params.id}`,params, 
